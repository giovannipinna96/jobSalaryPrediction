...
def get_jobs(keyword, num_jobs, verbose):
    ...
    while len(jobs) < num_jobs:  # If true, should be still looking for new jobs.
        ...
        # job_buttons = driver.find_elements_by_xpath('.//ul[@class ="hover p-0  job-search-key-kgm6qi exy0tjh1"]')
        job_buttons = driver.find_elements_by_xpath('.//*[@id= "MainCol"]//a[@class= "jobLink"]')
        try:
            for job_button in job_buttons:
                ...
                while (collected_successfully < 100):
                    ...
                    try:
                        company_name = driver.find_element_by_xpath('.//div[@class="css-dufhjo e1tk4kwz0"]').text
